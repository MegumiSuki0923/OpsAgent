...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path: str):
        server_params = StdioServerParameters(
            command='uv',
            args=['run', 'mcp_server/weather.py'],
            env=None
        )
    ...
    # 否则会出现不调用工具，自己乱回答的情况
        system_prompt = (
            ...
            "You have the function of online weather search. "
            "Please MUST call weather tool to search the Internet content before answering."
...
async def main():
    ...
    try:
        ...
        if not api_key:
            print("\nNo DEEPSEEK_API_KEY found. Set your API key before running:")
